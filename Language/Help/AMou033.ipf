...
Ce programme peut ˆtre utilis‚ pour la configuration du comportement de la
roulette des souris "Wheel mouse" (comme les "Intelli-Mouse"). 
Il permet &colon. 

:ul compact.
:li.le contr“le des op‚rations de la roulette,
:li.le paramŠtrage du nombre d'incr‚ments de d‚filement,
...
:li.:link reftype=hd refid=keyboard.Action sur la fenˆtre active:elink.
:li.:link reftype=hd refid=pointer.Action sur la fenˆtre sous le pointeur de souris:elink.
:li.:link reftype=hd refid=msgscroll.Messages d‚filement:elink.
:li.:link reftype=hd refid=msgline.Messages clavier:elink.
:li.:link reftype=hd refid=msgpage.D‚filement de la page entiŠre par unit‚:elink.
...
fenˆtres de texte, simulant l'appui sur une touche de d‚placement, 
dans la mesure o— les fenˆtres supportent cette fonction. 

:h2 res=1904 id=msgpage.Mode de fonctionnement - D‚filement de la page entiŠre par unit‚
:p.Si l'option est activ‚e, un message WM_CHAR sera envoy‚ aux 
fenˆtres de texte, simulant l'appui sur la touche Page Haut ou Page 
Bas, dans la mesure o— les fenˆtres supportent cette fonction. 
...
:h2 res=1906 id=keyboard.Action sur la fenˆtre active
:p.Si l'option est activ‚e, la barre de d‚filement verticale de la 
fenˆtre active sera actionn‚e. 
:p.Avec certaines souris, la fenˆtre se trouvant sous le pointeur de 
souris peut ˆtre activ‚e en cliquant sur la roulette. 
:note.pour certaines fenˆtres, il se peut que les 'sous-fenˆtres' 
contiennent aussi des barres de d‚filement (des cadres dans Netscape 
Communicator, par exemple). Dans ce cas, la fenˆtre qui a ‚t‚ 
s‚lectionn‚e en dernier est celle qui sera prise en compte. 

:h2 res=1907 id=pointer.Action sur la fenˆtre sous le pointeur de souris
:p.Si l'option est activ‚e, la barre de d‚filement verticale de la 
fenˆtre qui se trouve sous le pointeur de souris sera actionn‚e. 
:note.la fenˆtre n'a pas besoin d'ˆtre active ni complŠtement visible
… ce moment l…. 
...
paramŠtres avant les derniŠres modifications. 


:h2 id=standard.Par d‚faut
:p.Les paramŠtres par d‚faut seront restaur‚s. 
...
:p.Les paramŠtrages seront effectu‚s en s‚lectionnant les boutons 
...
:p.Cette glissiŠre fixe le nombre utilis‚ pour l'accroissement des 
...
page, une description d'un contr“le ou d'une fenˆtre sera 
recherch‚e. 
...
:p.Le paramŠtrage peut ˆtre fait par s‚lection des boutons 
...
:p.Le comportement est affich‚ dans la boŒte du bas. 
La colonne de gauche d‚finit la fenˆtre ou le contr“le qui r‚agira 
au tour de roulette.
...
toujours VRAI. 
Ce champ doit ˆtre vide pour les classes du WPS. 
:li.:hp2.Classe:ehp2.
.br
Classe de fenˆtre de la fenˆtre ou du contr“le. 
Ici doit ˆtre entr‚ soit le nom de la classe (respecter la casse !) 
soit l'identificateur pr‚c‚d‚ d'un &osq.&numsign.&csq.&per. 
Si ce champ est laiss‚ vide, le r‚sultat de comparaison sera 
toujours VRAI. 
:li.:hp2.Classe parente:ehp2.
.br
Classe de fenˆtre parente de la fenˆtre ou du contr“le. 
Ici doit ˆtre entr‚ soit le nom de la classe (respecter la casse !) soit 
...
:li.:hp2.Mode:ehp2.
.br
D‚finit le type de message … envoyer … la fenˆtre ou au contr“le. 
.br
...
d'une page entiŠre par unit‚ de d‚filement:elink.&per. 
.br
...
clavier:elink.&per. 
L':hp2.ensemble:ehp2. r‚agit sur tous les paramŠtres. 
:li.:hp2.RelationV (respectivement RelationH):ehp2. 
.br
D‚finit si le message doit ˆtre envoy‚ directement … la fenˆtre ou 
au contr“le, ou si une recherche plus approfondie doit ˆtre faite 
dans la hi‚rarchie de la fenˆtre. 
Voici la signification des diff‚rents ‚l‚ments &colon. 
:ul compact.
...
zone invisible sous le champ d'entr‚e si la boŒte de liste ne 
s'affiche pas. 
:li.:hp2.Soeur[Option]:ehp2.&colon. une fenˆtre soeur sera 
...
.br
D‚finit le message envoy‚ … la fenˆtre ou au contr“le. 
Ci-aprŠs sont pr‚sent‚s les diff‚rents messages disponibles &colon. 
:ul compact.
...
clavier Haut/Bas. 
Le nombre de messages envoy‚ est d‚fini par les paramŠtres de la 
...
Le nombre de messages envoy‚ est d‚fini par les paramŠtres dans 
...
mais le nombre de messages est d‚fini par les paramŠtres de la page 
:link reftype=hd refid=scrollitem.Vitesse de d‚filement:elink.&per. 
:li.:hp2.N x WM_HSCROLL:ehp2. &colon. comme :hp2.WM_HSCROLL:ehp2., 
mais le nombre de messages est d‚fini par les paramŠtres de la page 
:link reftype=hd refid=scrollitem.Vitesse de d‚filement:elink.&per. 
:li.:hp2.WM_CHAR:ehp2. &colon. un message caractŠre est envoy‚. Les 
mˆmes options que pour :hp2.WM_CONTROL:ehp2. sont possibles. 
:eul.
:eul.
...
message caractŠre PgHaut/PgBas est envoy‚ dans le cas d'un 
d‚filement vertical. 
:p.:artwork name='C:\work\c\amouse\Language\Help\Command_Line_033.bmp' align=left.
:p.Si vous actionnez la roulette sur une fenˆtre de ligne de 
commande, le comportement par d‚faut est de faire d‚filer le contenu 
de la fenˆtre (si les barres de d‚filement sont pr‚sentes). 
Les paramŠtres affich‚s ici provoquent le d‚filement de l'historique 
...
:p.Cette boŒte de dialogue est utilis‚e pour ins‚rer une nouvelle 
...
:hp2.Description:ehp2. pourra ˆtre utilis‚ pour l'insertion de tout 
texte d‚fini par l'utilisateur identifiant les entr‚es de la boŒte 
...
:li.:link reftype=hd refid=keycombset3.Combinaison 3:elink.
:li.:link reftype=hd refid=keycombset4.Combinaison 4:elink.
:li.:link reftype=hd refid=keycombset5.Combinaison 5:elink.
:li.:link reftype=hd refid=keycombset6.Combinaison 6:elink.
:li.:link reftype=hd refid=keycombset7.Combinaison 7:elink.
:li.:link reftype=hd refid=keycombset8.Combinaison 8:elink.
:li.:link reftype=hd refid=keycombset9.Combinaison 9:elink.
:li.:link reftype=hd refid=keycombset10.Combinaison 10:elink.
:li.:link reftype=hd refid=keycomb.Combinaison de touches:elink.
:li.:link reftype=hd refid=cancel.D‚faire:elink.
:li.:link reftype=hd refid=standard.Par d‚faut:elink.
:eul.
:note.
...
correctement. 
:li.:hp5.R‚duire/Cacher toutes les fenˆtres:ehp5.
.br
Toutes les fenˆtres seront r‚duites ou cach‚es en fonction du 
comportement de la fenˆtre. 
:li.:hp5.Restauration de toutes les fenˆtres:ehp5.
.br
Toutes les fenˆtres seront restaur‚es … la taille qu'elles avaient 
avant la fonction de R‚duction/Masquage/Agrandissement. 
:li.:hp5.Liste des fenˆtres:ehp5.
.br
La liste des fenˆtres sera affich‚e. 
...
:li.:hp5.Agrandissement de la fenˆtre.:ehp5.
.br
La fenˆtre sera agrandie. 
:li.:hp5.R‚duire/Cacher la fenˆtre:ehp5.
.br
La fenˆtre sera r‚duite ou cach‚e, en fonction de son comportement. 
:li.:hp5.Restauration de la fenˆtre:ehp5.
.br
La fenˆtre sera restaur‚e … la taille qu'elle avait avant la 
...
:li.:hp5.Placer la fenˆtre … l'arriŠre-plan:ehp5.
.br
La fenˆtre sous le pointeur de la souris sera plac‚e sous toutes les 
autres fenˆtres du bureau. 
...
:p.Cette boŒte de contr“les est utilis‚e pour s‚lectionner l'action 
… effectuer … l'appui sur le bouton 3. 

:h2 res=1502 id=button4.Bouton 4
:p.Cette boŒte de contr“les est utilis‚e pour s‚lectionner 
...
:h2 res=1529 id=keycombset3.Combinaison de touches 3
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
combinaison:elink.&per.

:h2 res=1530 id=keycombset4.Combinaison de touches 4
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1531 id=keycombset5.Combinaison de touches 5
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1532 id=keycombset6.Combinaison de touches 6
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1533 id=keycombset7.Combinaison de touches 7
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1534 id=keycombset8.Combinaison de touches 8
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1535 id=keycombset9.Combinaison de touches 9
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1536 id=keycombset10.Combinaison de touches 10
:p.Ce bouton est utilis‚ pour assigner la 
:link reftype=hd refid=keycomb.combinaison de touches:elink. du champ d'entr‚e
au bouton de la souris, si l'‚l‚ment :hp1.combinaison de touches:ehp1. a ‚t‚
s‚lectionn‚ dans la :link reftype=hd refid=button3.boŒte de
...
:h2 res=1537 id=keycomb.D‚finition de la combinaison de touches
:p.Ce champ d'entr‚e permet de d‚finir les combinaisons de touches qui peuvent
ˆtre assign‚es … un quleconque bouton de souris. 
:p.AprŠs qu'une combinaison de touches a ‚t‚ d‚finie et assign‚e … un bouton
de la souris, elle sera envoy‚e … l'application … l'appui sur ce bouton. 
:p.Pour d‚finir une combinaison de touches, le champ d'entr‚e doit ˆtre
s‚lectionn‚. La combiaison de touches doit ensuite ˆtre effectu‚e (par exemple
:hp2.Alt-F4:ehp2.). 
Le champ d'entr‚e affiche alors la combinaison saisie. En appuyant sur l'un
des boutons :hp2.D‚finir:ehp2.&coma. la combinaison est alors assign‚e au
bouton de la souris correspondant. 
...
:p.Le paramŠtrage s'effectue en cochant les options.
...
:li.:link reftype=hd refid=click_combo.Clic sur boŒte de s‚lection:elink.
...
:h2 res=1702 id=click_combo.Clic sur boŒte de s‚lection
:p.Si l'option est s‚lectionn‚e, un clic sur un champ d'entr‚e 
faisant partie d'une boŒte de s‚lection r‚sulte en un d‚roulement de 
la partie boŒte de s‚lection. 

:h2 res=1703 id=smartcruise.SmartCruise
:p.Active la fonction SmartCruise des souris Logitech MX500, MX700 et MX1000. 
Si l'option est s‚lectionn‚e, les paramŠtres des boutons 7, 8, 9 et 10 sont
...
fil, supportant les requˆtes vers ces donn‚es. 
...
:p.Si l'option est activ‚e, une boŒte de messsage apparaŒtra si la batterie
...
:p.Cette glissiŠre permet de d‚finir la r‚activit‚ de la souris. 

:h2 res=2502 id=mouaccel_value.Valeur de l'acc‚l‚ration
:p.Cette glissiŠre permet de d‚finir la valeur de l'acc‚l‚ration. 

:h2 res=2503 id=mouaccel_threshold.D‚lai d'activation de l'acc‚l‚ration
:p.Cette glissiŠre permet de d‚finir le seuil … partir duquel il y 
aura acc‚l‚ration. 
