...
otterrebbe premendo uno dei tasti cursore della tastiera (se tale funzione Š supportata
dalla finestra).

:h2 res=1904 id=msgpage.Modalit… funzionamento - Scorrimento di una pagina per unit… di scrolling
:p.Selezionando questa impostazione viene inviato alla finestra un messaggio WM_CHAR. Il risultato Š lo stesso che si
otterrebbe premendo il tasto PaginaSu o PaginaGi— della tastiera (se tale funzione Š supportata
dalla finestra).
...
:li.:hp2.Option:ehp2.
.br
Va inserita la eventuale opzione per una &osq.vRelation&csq. o &osq.hRelation&csq. specifica (per ulteriori spiegazioni
...
:li.:hp2.vRelation e hRelation:ehp2.
.br
...
:li.:hp2.Next:ehp2.&colon. la ricerca continua sull'asse z per altri controlli che si dovessero trovare sotto
...
:ul compact.
:li.:hp2.page:ehp2.&colon. invia i codici tastiera per i tasti PaginaSu-/PaginaGi—.
...
Il numero di messaggi inviati dipende dall'impostazione :link reftype=hd refid=scrollitem.Velocit… rotella:elink..
:eul.
:li.:hp2.WM_VSCROLL:ehp2.&colon. invia un messaggio di scroll verticale alla barra di scorrimento verticale.
:li.:hp2.WM_HSCROLL:ehp2.&colon. invia un messaggio di scroll orizzontale alla barra di scorrimento orizzontale.
...
(&odq.mult cursor&cdq.). La finestra Mozilla Š identificata quando sia :hp2.Class:ehp2. che :hp2.Parent Class:ehp2. appartengono al tipo :hp2.MozillaWindowClass:ehp2..
...
PaginaSu/PaginaGi— (solo per lo scorrimento verticale).
...
:i1 id=keys.Tasti, 1
:p.Questa pagina permette di definire funzioni specifiche per i tasti 3, 4 e 5 del mouse.
...
spostamento viene confrontata con i valori delle soglie di primo e di secondo livello. Se il mouse viene
